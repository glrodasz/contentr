  ...
  return [
    {
      ...
      The key task is to identify and extract dialogues that are relevant, engaging, and meaninful on topics such as ${buildTopics(
        TOPICS
      )}.
      ...
      -  If a dialogue content is less than 200 words or more than 400 words please discard it, avoid return an apology or comment.
